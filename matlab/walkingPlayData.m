function walkingPlayData(skelStruct, channels, limits, motion, subject, frameLength) 

% WALKINGPLAYDATA Play walking motion capture data.
% FORMAT 
...
%
% COPYRIGHT : Mauricio Alvarez, Neil D. Lawrence, 2012
%

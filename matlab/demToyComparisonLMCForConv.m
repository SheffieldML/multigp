% DEMTOYCOMPARISONLMCFORCONV Samples from a multi GP with LMC covariance
% FORMAT
...
% (LMC). The parameters in the LMC have been chosen such that the samples
% look like the ones obtained from a process convolution covariance. This 
% script was used to generate figure 5.2, in the paper "Kernels for 
% vector-valued functions: a review", appearing in Foundations and Trends 
% in Machine Learning.
%
...
%print('-depsc', '~/Dropbox/MOLSurvey/FoTML/toyLMCConv', '-loose');
